...
//  EssentialAppTests
//
//  Created by Greener Chen on 2023/12/27.
//
...
class CommentsUIIntegrationTests: XCTestCase {
    ...
    func test_loadCommentsActions_requestCommentsFromLoader() {
        ...
        XCTAssertEqual(loader.loadCommentsCallCount, 0, "Expected no loading requests before view is loading")
    ...
    func test_loadCommentsActions_runsAutomaticallyOnlyOnFirstAppearance() {
        ...
        sut.simulateAppearance()
        XCTAssertEqual(loader.loadCommentsCallCount, 1, "Expected no loading request when view appears on the second time")
    }
    ...
    func test_deinit_cancelRunningRequest() {
        ...
        // use autoreleasepool to prevent memory leaks on sut
        autoreleasepool {
