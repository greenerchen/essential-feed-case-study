...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    private lazy var logger: Logger = .init(subsystem: "com.essentialdeveloper.EssentialAppCaseStudy", category: "main")
...
extension Publisher {
    ...
    func logElaspsedTime(url: URL, logger: Logger) -> AnyPublisher<Output, Failure> {
