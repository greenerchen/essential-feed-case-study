...
final class ImageCommentsSnapshotTests: XCTestCase {
    ...
    func test_listWithComments() {
        ...
        assert(snapshot: sut.snapshot(for: .iPhone15(style: .light)), named: "IMAGE_COMMENTS_light")
        assert(snapshot: sut.snapshot(for: .iPhone15(style: .dark)), named: "IMAGE_COMMENTS_dark")
        assert(snapshot: sut.snapshot(for: .iPhone15(style: .light, contentSize: .extraExtraExtraLarge)), named: "IMAGE_COMMENTS_light_extraExtraExtraLarge")
    }
