...
final class URLSessionHTTPClientTests: XCTestCase {
    ...
    func test_getFromURL_performsGETRequestWithURL() {
        ...
        URLProtocolStub.observeRequests { request in
            ...
            // Remove requestObserver to avoid API violation because the expectation fullfill count is 1 by default. If observeRequests is set to URLProtocolStub, exp.fulfill() will be call twice in every test which causes API violation.
            URLProtocolStub.removeRequestObserver()
        }
